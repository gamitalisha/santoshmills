            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-4" style="text-align: right;">
                        <a href="#" key="t-flag">
                            <button type="button" class="btn btn-outline-primary waves-effect waves-light">Add Size</button>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <center>
                    <div class="col-lg-6">
                        ...
                        <input type="hidden" name="hidden_id" id="hidden_id" value="{{@$group->id}}"/>
                           <input class="form-control me-auto" name="size" id="size" type="text" placeholder="Enter Size"
...
$(document).ready(function() {
            ...
            $("#btn-submit").click(function(e) {
                ...
                if (name == '') {
                    toastr.warning("Please Enter Size Name");
                } else {
                    $.ajax({
                        type: 'POST',

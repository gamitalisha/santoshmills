    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        <h4 class="card-title">Group Master Details</h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <center>
                        <div class="col-lg-6">
                            <div class="hstack gap-3">
                                ...
                                <input class="form-control me-auto" name="name" id="name" type="text"
                                    placeholder="Enter Group Name" aria-label="Enter Group Name">

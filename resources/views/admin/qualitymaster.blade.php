    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        <h4 class="card-title">Quality Master</h4>
                    </div>
                ...
                <center>
                    <div class="col-lg-6">
                        ...
                        <input type="hidden" name="hidden_id" id="hidden_id" />
                           <input class="form-control me-auto" name="quality_master" id="quality_master" type="text" placeholder="Enter Quality"
                ...
                $.ajax({
                    ...
                    success: function(data) {
                         console.log("mydata",data);
                          ...
                          $('#quality_master').val(data['quality_master']);

@extends('layouts.app')
@section('title', 'Sub Group Master')
@section('content')
<style>
</style>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        <h4 class="card-title">Sub Group Master</h4>
                    </div>
                ...
                <center>
                    <div class="col-lg-6">
                        ...
                        <input type="hidden" name="hidden_id" id="hidden_id" />
                           <input class="form-control me-auto" name="sub_group" id="sub_group" type="text" placeholder="Enter Subgroup Name"
...
$("#btn-submit").click(function(e) {
    e.preventDefault();
    var name = $("#sub_group").val();
    var hidden_id = $("#hidden_id").val();
    if (name == '') {
        toastr.warning("Please Enter Subgroup name");
    } else {
        $.ajax({
            type: 'POST',
            url: "{{ route('subgroup.store') }}",
            data: {
                _token: "{{ csrf_token() }}",
                sub_group: name,
                hidden_id: hidden_id
